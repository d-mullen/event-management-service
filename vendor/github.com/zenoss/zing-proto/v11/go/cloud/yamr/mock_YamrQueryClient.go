...
// NewMockYamrQueryClient creates a new instance of MockYamrQueryClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrQueryClient(t testing.TB) *MockYamrQueryClient {
