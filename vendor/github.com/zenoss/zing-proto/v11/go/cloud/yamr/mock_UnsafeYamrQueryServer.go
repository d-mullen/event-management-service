...
type mockConstructorTestingTNewMockUnsafeYamrQueryServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockUnsafeYamrQueryServer creates a new instance of MockUnsafeYamrQueryServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockUnsafeYamrQueryServer(t mockConstructorTestingTNewMockUnsafeYamrQueryServer) *MockUnsafeYamrQueryServer {
