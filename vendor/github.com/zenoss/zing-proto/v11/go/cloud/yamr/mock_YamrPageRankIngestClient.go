...
// NewMockYamrPageRankIngestClient creates a new instance of MockYamrPageRankIngestClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrPageRankIngestClient(t testing.TB) *MockYamrPageRankIngestClient {
