...
type mockConstructorTestingTNewMockYamrResolverClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockYamrResolverClient creates a new instance of MockYamrResolverClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrResolverClient(t mockConstructorTestingTNewMockYamrResolverClient) *MockYamrResolverClient {
