...
type mockConstructorTestingTNewMockYamrIngestServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockYamrIngestServer creates a new instance of MockYamrIngestServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrIngestServer(t mockConstructorTestingTNewMockYamrIngestServer) *MockYamrIngestServer {
