...
type mockConstructorTestingTNewMockYamrServiceServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockYamrServiceServer creates a new instance of MockYamrServiceServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrServiceServer(t mockConstructorTestingTNewMockYamrServiceServer) *MockYamrServiceServer {
