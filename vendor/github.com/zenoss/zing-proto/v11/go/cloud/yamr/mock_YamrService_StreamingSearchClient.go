...
type mockConstructorTestingTNewMockYamrService_StreamingSearchClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockYamrService_StreamingSearchClient creates a new instance of MockYamrService_StreamingSearchClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrService_StreamingSearchClient(t mockConstructorTestingTNewMockYamrService_StreamingSearchClient) *MockYamrService_StreamingSearchClient {
