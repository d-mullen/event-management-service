...
// newMockIsSort_Sort creates a new instance of mockIsSort_Sort. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsSort_Sort(t testing.TB) *mockIsSort_Sort {
