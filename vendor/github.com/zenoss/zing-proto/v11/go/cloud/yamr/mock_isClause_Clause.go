...
// newMockIsClause_Clause creates a new instance of mockIsClause_Clause. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsClause_Clause(t testing.TB) *mockIsClause_Clause {
