...
// NewMockYamrPageRankIngest_UpdateClient creates a new instance of MockYamrPageRankIngest_UpdateClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockYamrPageRankIngest_UpdateClient(t testing.TB) *MockYamrPageRankIngest_UpdateClient {
