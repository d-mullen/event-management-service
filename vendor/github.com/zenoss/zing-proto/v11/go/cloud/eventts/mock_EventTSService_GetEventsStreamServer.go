...
// NewMockEventTSService_GetEventsStreamServer creates a new instance of MockEventTSService_GetEventsStreamServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventTSService_GetEventsStreamServer(t testing.TB) *MockEventTSService_GetEventsStreamServer {
