...
type mockConstructorTestingTNewMockEventTSServiceClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockEventTSServiceClient creates a new instance of MockEventTSServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventTSServiceClient(t mockConstructorTestingTNewMockEventTSServiceClient) *MockEventTSServiceClient {
