...
type mockConstructorTestingTnewMockIsFilter_Op interface {
	mock.TestingT
	Cleanup(func())
}

// newMockIsFilter_Op creates a new instance of mockIsFilter_Op. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsFilter_Op(t mockConstructorTestingTnewMockIsFilter_Op) *mockIsFilter_Op {
