...
// NewMockEventContextIngestClient creates a new instance of MockEventContextIngestClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventContextIngestClient(t testing.TB) *MockEventContextIngestClient {
