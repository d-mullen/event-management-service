...
// NewMockEventContextQueryClient creates a new instance of MockEventContextQueryClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventContextQueryClient(t testing.TB) *MockEventContextQueryClient {
