...
type mockConstructorTestingTNewMockEventContextIngestServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockEventContextIngestServer creates a new instance of MockEventContextIngestServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventContextIngestServer(t mockConstructorTestingTNewMockEventContextIngestServer) *MockEventContextIngestServer {
