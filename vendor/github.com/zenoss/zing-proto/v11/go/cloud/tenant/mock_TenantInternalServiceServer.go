...
func (_m *MockTenantInternalServiceServer) GetAuthInfo(_a0 context.Context, _a1 *GetAuthRequest) (*GetAuthResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// MockTenantInternalServiceServer_GetAuthInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAuthInfo'
type MockTenantInternalServiceServer_GetAuthInfo_Call struct {
	*mock.Call
}
...
//  - _a0 context.Context
//  - _a1 *GetAuthRequest
func (_e *MockTenantInternalServiceServer_Expecter) GetAuthInfo(_a0 interface{}, _a1 interface{}) *MockTenantInternalServiceServer_GetAuthInfo_Call {
	return &MockTenantInternalServiceServer_GetAuthInfo_Call{Call: _e.mock.On("GetAuthInfo", _a0, _a1)}
}

func (_c *MockTenantInternalServiceServer_GetAuthInfo_Call) Run(run func(_a0 context.Context, _a1 *GetAuthRequest)) *MockTenantInternalServiceServer_GetAuthInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTenantInternalServiceServer_GetAuthInfo_Call) Return(_a0 *GetAuthResponse, _a1 error) *MockTenantInternalServiceServer_GetAuthInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
type mockConstructorTestingTNewMockTenantInternalServiceServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockTenantInternalServiceServer creates a new instance of MockTenantInternalServiceServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockTenantInternalServiceServer(t mockConstructorTestingTNewMockTenantInternalServiceServer) *MockTenantInternalServiceServer {
