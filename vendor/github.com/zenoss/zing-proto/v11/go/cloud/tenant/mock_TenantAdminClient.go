...
// NewMockTenantAdminClient creates a new instance of MockTenantAdminClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockTenantAdminClient(t testing.TB) *MockTenantAdminClient {
