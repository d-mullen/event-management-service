...
type mockConstructorTestingTnewMockIsChangeTenantNameRequest_TenantIdentifier interface {
	mock.TestingT
	Cleanup(func())
}

// newMockIsChangeTenantNameRequest_TenantIdentifier creates a new instance of mockIsChangeTenantNameRequest_TenantIdentifier. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsChangeTenantNameRequest_TenantIdentifier(t mockConstructorTestingTnewMockIsChangeTenantNameRequest_TenantIdentifier) *mockIsChangeTenantNameRequest_TenantIdentifier {
