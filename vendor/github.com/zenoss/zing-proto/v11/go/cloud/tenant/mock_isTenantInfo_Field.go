...
// newMockIsTenantInfo_Field creates a new instance of mockIsTenantInfo_Field. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsTenantInfo_Field(t testing.TB) *mockIsTenantInfo_Field {
