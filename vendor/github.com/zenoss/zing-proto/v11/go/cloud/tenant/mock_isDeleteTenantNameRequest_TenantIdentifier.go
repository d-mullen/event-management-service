...
// newMockIsDeleteTenantNameRequest_TenantIdentifier creates a new instance of mockIsDeleteTenantNameRequest_TenantIdentifier. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsDeleteTenantNameRequest_TenantIdentifier(t testing.TB) *mockIsDeleteTenantNameRequest_TenantIdentifier {
