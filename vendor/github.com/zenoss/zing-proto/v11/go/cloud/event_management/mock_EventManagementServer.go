...
type mockConstructorTestingTNewMockEventManagementServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockEventManagementServer creates a new instance of MockEventManagementServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventManagementServer(t mockConstructorTestingTNewMockEventManagementServer) *MockEventManagementServer {
