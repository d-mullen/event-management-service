...
type Annotation struct {
	...
	EventId      string `protobuf:"bytes,1,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`                // event id, must match an existing event
	OccurrenceId string `protobuf:"bytes,2,opt,name=occurrence_id,json=occurrenceId,proto3" json:"occurrence_id,omitempty"` // occurrence id, must match an existing occurrence
	AnnotationId string `protobuf:"bytes,3,opt,name=annotation_id,json=annotationId,proto3" json:"annotation_id,omitempty"` // leave out for new annotation,  must match an existing annotation for edits
	Annotation   string `protobuf:"bytes,4,opt,name=annotation,proto3" json:"annotation,omitempty"`                         // text to add or update
}
...
var file_zenoss_zing_proto_cloud_event_management_service_proto_rawDesc = []byte{
	...
	0x32, 0x8f, 0x02, 0x0a, 0x0f, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	0x01, 0x2a, 0x42, 0x6b, 0x0a, 0x2b, 0x6f, 0x72, 0x67, 0x2e, 0x7a, 0x65, 0x6e, 0x6f, 0x73, 0x73,
	0x2e, 0x7a, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x62,
...
var file_zenoss_zing_proto_cloud_event_management_service_proto_depIdxs = []int32{
	...
	3,  // 9: zenoss.cloud.EventManagement.SetStatus:output_type -> zenoss.cloud.EventStatusResponse
	7,  // 10: zenoss.cloud.EventManagement.Annotate:output_type -> zenoss.cloud.EventAnnotationResponse
