...
// NewMockEventManagementClient creates a new instance of MockEventManagementClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventManagementClient(t testing.TB) *MockEventManagementClient {
