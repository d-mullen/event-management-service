...
type mockConstructorTestingTNewMockUnsafeEventManagementServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockUnsafeEventManagementServer creates a new instance of MockUnsafeEventManagementServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockUnsafeEventManagementServer(t mockConstructorTestingTNewMockUnsafeEventManagementServer) *MockUnsafeEventManagementServer {
