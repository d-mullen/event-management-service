...
type mockConstructorTestingTNewMockEventQueryService_SearchStreamClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockEventQueryService_SearchStreamClient creates a new instance of MockEventQueryService_SearchStreamClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventQueryService_SearchStreamClient(t mockConstructorTestingTNewMockEventQueryService_SearchStreamClient) *MockEventQueryService_SearchStreamClient {
