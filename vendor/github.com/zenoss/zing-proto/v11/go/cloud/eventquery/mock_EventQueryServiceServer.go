...
// NewMockEventQueryServiceServer creates a new instance of MockEventQueryServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEventQueryServiceServer(t testing.TB) *MockEventQueryServiceServer {
