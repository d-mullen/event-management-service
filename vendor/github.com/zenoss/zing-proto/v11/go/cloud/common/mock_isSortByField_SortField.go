...
// newMockIsSortByField_SortField creates a new instance of mockIsSortByField_SortField. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsSortByField_SortField(t testing.TB) *mockIsSortByField_SortField {
