...
// newMockIsScalar_Value creates a new instance of mockIsScalar_Value. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsScalar_Value(t testing.TB) *mockIsScalar_Value {
