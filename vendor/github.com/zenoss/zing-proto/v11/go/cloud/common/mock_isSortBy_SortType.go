...
// newMockIsSortBy_SortType creates a new instance of mockIsSortBy_SortType. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsSortBy_SortType(t testing.TB) *mockIsSortBy_SortType {
