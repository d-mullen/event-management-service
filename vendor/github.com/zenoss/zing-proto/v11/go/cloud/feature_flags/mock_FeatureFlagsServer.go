...
type mockConstructorTestingTNewMockFeatureFlagsServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockFeatureFlagsServer creates a new instance of MockFeatureFlagsServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFeatureFlagsServer(t mockConstructorTestingTNewMockFeatureFlagsServer) *MockFeatureFlagsServer {
