...
type mockConstructorTestingTNewMockFeatureFlagsClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockFeatureFlagsClient(t mockConstructorTestingTNewMockFeatureFlagsClient) *MockFeatureFlagsClient {
